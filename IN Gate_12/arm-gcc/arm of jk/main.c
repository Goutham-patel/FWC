...
int main(void)
{
    ...
    // LED pins Output
       ...
       PyHal_GPIO_SetDir(20, 1); // J1
       PyHal_GPIO_SetDir(21, 1); // J2
       PyHal_GPIO_SetDir(22, 1); // K1
       PyHal_GPIO_SetDir(23, 1); // k2
       PyHal_GPIO_SetDir(19, 1); // Q1
       PyHal_GPIO_SetDir(18, 1); // Q2


     uint32_t Q1=1, Q2=0, J1 = 1, J2 = 1, K1 = 1, K2 = 1;
while (1)
{
    PyHal_GPIO_Set(5, 1); // Set clk high
    HAL_DelayUSec(1000000);

    // Read GPIO values
    Q1 = PyHal_GPIO_Get(18);
    Q2 = PyHal_GPIO_Get(19);
    J1 = PyHal_GPIO_Get(20);
    J2 = PyHal_GPIO_Get(21);
    K1 = PyHal_GPIO_Get(22);
    K2 = PyHal_GPIO_Get(23);

    PyHal_GPIO_Set(5, 1); // Set clk low
    HAL_DelayUSec(1000000);
}
